"""
面板检测 debug 模式：在可视化 canvas 上标注按钮/旋钮的深度采样区域。

绿色像素 = 参与深度计算的有效点（10-90 分位数内）
橙色像素 = 被裁剪的离群深度点
红色像素 = 深度无效 (depth=0)
青色矩形 = 采样区域边界 (bbox 中心 45%)

用法:
  ros2 launch panel_detection panel_controls_debug.launch.py
"""
...
def generate_launch_description():
    ...
    detect_node = Node(
        ...
        name='panel_controls_debug_node',
        output='screen',
        parameters=[{
